...
const BotonBio = styled.button<BotonProps>`
  border-radius: 5px;
  ...
  font-size: 1.4rem;
  background-color: ${({ active }) => active && '#fdd835'};
  color: ${({ active }) => active && 'whitesmoke'};
  text-shadow: ${({ active }) =>
    active &&
...
export { BioContainer, BioDescripcion, BioImagen, BioNombre, ContenedorBotones, BotonBio };
