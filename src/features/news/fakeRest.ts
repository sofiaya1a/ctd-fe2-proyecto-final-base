import { INoticias } from "./types/index";
...
const data = [
  {
    ...
    esPremium: false,
    fuente: 'https://www.mirror.co.uk/tv/tv-news/simpsons-fans-convinced-show-predicted-25140770',
  },
  {
    id: 2,
    ...
    esPremium: false,
    fuente: 'https://www.mirror.co.uk/tv/tv-news/simpsons-teams-up-marvel-exciting-24435616',
  },
  {
    id: 3,
    ...
    fecha: simularTiempoTranscurrido(1200000),
    esPremium: true,
    fuente: 'https://www.mirror.co.uk/tv/tv-news/simpsons-correctly-predicts-future-again-24547074',
  },
];
